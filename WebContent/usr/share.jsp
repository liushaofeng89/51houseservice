            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="index"><i class="fa fa-dashboard fa-fw"></i> 我的空间</a>
                        </li>
                        <li>
                            <a href="business"><i class="fa fa-puzzle-piece fa-fw"></i> 我的足迹</a>
                        </li>
                        <li>
                        	<a href="profile"><i class="fa fa-user fa-fw"></i> 个人中心</a>
                        </li>
                        <li>
                        	<a href="share" class="active"><i class="fa fa-share-alt fa-fw"></i> 我要推广</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
            ...
            <div class="row">
                <div class="col-lg-12" style="padding-top:20px">
                    <ul id="myTab" class="nav nav-tabs">
					   ...
					   <li class="pull-right">
					   	<button type="button" class="btn btn-default"><i class="fa fa-copy fa-fw"></i> 获取分享链接</button>
					   </li>
					</ul>
